...
//        long startOfYear = scanner.nextLong();
        ...
        } while (!thisMoment.equals(lastMoment)); // вам нужно вывести график на семь дней
    ...
    private static int dayOfYearFromInstant(Instant startOfYear, Instant time) {
        ...
        int i = (int) (fromStartOfYear / 60 / 60 / 24);
        return i;
    }
